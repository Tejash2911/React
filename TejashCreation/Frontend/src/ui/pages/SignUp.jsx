...
const Button = styled.button`
  margin: 15px 0px;
  //margin right used to make it take full width
  margin-right: 60%;
  min-width: 40%;
  border: none;
        ...
        {signupSuccess ? (
          ...
          <Wrapper>
            ...
            <Form onSubmit={handleSubmit} autoComplete="on">
              ...
              <Input name="email" type="email" placeholder="Email" onChange={handleOnChange} autoComplete="on" />
              <FormValidationError>{formErrors.email}</FormValidationError>

              <Input name="password" type="password" placeholder="Password" onChange={handleOnChange} autoComplete="off" />
              <br />
