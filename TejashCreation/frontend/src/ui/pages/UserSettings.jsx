...
import { setAddress, updateUser } from "../../redux/userSlice";
            ...
            <Content>
              ...
              {isActivated === 1 && (
                <form onSubmit={handleUpdateProfile}>
                  <p>First name</p>
                  <Input type="text" name="firstName" placeholder="First name" value={userDataForm.firstName} onChange={handleInputChange} />
                  <p>Last name</p>
                  <Input type="text" name="lastName" placeholder="Last name" value={userDataForm.lastName} onChange={handleInputChange} />
                  <p>Email address</p>
                  <Input type="email" name="email" placeholder="Email" value={userDataForm.email} onChange={handleInputChange} />
                  <p>Number</p>
                  <Input type="tel" name="number" placeholder="Phone number" value={userDataForm.number} onChange={handleInputChange} />
                  <p>Password</p>
                  <FakeInput>
