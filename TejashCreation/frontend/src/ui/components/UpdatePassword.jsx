  ...
  return (
    <ModalComp isOpen={isOpen}>
      <StyledForm onSubmit={handleSubmit}>
        ...
        <StyledInput type="text" name="currentPass" value={formData.currentPass} onChange={handleChange} placeholder="Enter Current Password" required />

        <StyledLabel>New Password: </StyledLabel>
        <StyledInput type="text" name="password" value={formData.password} onChange={handleChange} placeholder="Enter Password" required />

        <StyledLabel>Confirm Password: </StyledLabel>
        <StyledInput type="text" name="confPass" value={formData.confPass} onChange={handleChange} placeholder="Enter Confirm Password" required />
